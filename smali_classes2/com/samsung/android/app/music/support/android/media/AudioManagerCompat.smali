...
.method private getPinDevice()I
    ...
    .line 2
    :cond_0
    iget-object p0, p0, Lcom/samsung/android/app/music/support/android/media/AudioManagerCompat;->mAudioManager:Landroid/media/AudioManager;

    new-array v1, v1, [Ljava/lang/Object;

    invoke-static {v0, p0, v1}, Lcom/samsung/android/app/music/support/samsung/ReflectionExtension;->invokeMethod(Ljava/lang/reflect/Method;Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public getFineVolume(I)I
    ...
    invoke-virtual {v0, p0, p1}, Lcom/samsung/android/app/music/support/sdl/android/media/SamsungAudioManagerCompat;->getFineVolume(Landroid/media/AudioManager;I)I
...
.method public getMediaVolumeInterval(Landroid/content/Context;)I
    ...
    .line 4
    :cond_0
    iget-object p0, p0, Lcom/samsung/android/app/music/support/android/media/AudioManagerCompat;->mSemSoundAssistantManager:Lcom/samsung/android/media/SemSoundAssistantManager;

    invoke-virtual {p0}, Lcom/samsung/android/media/SemSoundAssistantManager;->getMediaVolumeInterval()I
...
.method public getMultiSoundDeviceVolume(Landroid/content/Context;IIZ)I
    ...
    invoke-virtual {p0, p2}, Lcom/samsung/android/media/SemSoundAssistantManager;->getMultiSoundDeviceVolume(I)I
    ...
    .line 12
    iget-object p0, p0, Lcom/samsung/android/app/music/support/android/media/AudioManagerCompat;->mStreamMaxVolume:Ljava/lang/Integer;
...
.method public isMultiSoundOn(Landroid/content/Context;)Z
    ...
    .line 7
    invoke-static {p1, p0, v0}, Lcom/samsung/android/app/music/support/samsung/ReflectionExtension;->invokeMethod(Ljava/lang/reflect/Method;Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public isSafeMediaVolumeDeviceOn()Z
    ...
    .line 3
    :cond_0
    iget-object p0, p0, Lcom/samsung/android/app/music/support/android/media/AudioManagerCompat;->mSamsungAudioManagerCompat:Lcom/samsung/android/app/music/support/sdl/android/media/SamsungAudioManagerCompat;

    invoke-virtual {p0}, Lcom/samsung/android/app/music/support/sdl/android/media/SamsungAudioManagerCompat;->isSafeMediaVolumeDeviceOn()Z
...
.method public isSplitSoundOn()Z
    ...
    invoke-virtual {p0}, Lcom/samsung/android/app/music/support/sdl/android/media/SamsungAudioManagerCompat;->isSplitSoundOn()Z
...
.method public setFineVolume(III)V
    ...
    invoke-virtual {v0, p0, p1, p2, p3}, Lcom/samsung/android/app/music/support/sdl/android/media/SamsungAudioManagerCompat;->setFineVolume(Landroid/media/AudioManager;III)V
