.class public final Lcom/samsung/android/app/music/melon/list/chart/i;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/samsung/android/app/music/melon/list/chart/i$a;
    }
.end annotation
...
.method public constructor <init>()V
    ...
    .line 2
    new-instance v0, Lcom/samsung/android/app/music/melon/list/chart/i$c;

    invoke-direct {v0, p0}, Lcom/samsung/android/app/music/melon/list/chart/i$c;-><init>(Lcom/samsung/android/app/music/melon/list/chart/i;)V

    invoke-static {v0}, Lkotlin/h;->b(Lkotlin/jvm/functions/a;)Lkotlin/g;

    move-result-object v0

    iput-object v0, p0, Lcom/samsung/android/app/music/melon/list/chart/i;->T:Lkotlin/g;

    return-void
.end method

.method public static synthetic f1(Lcom/samsung/android/app/music/melon/list/chart/i;Ljava/util/List;)V
    .registers 2

    invoke-static {p0, p1}, Lcom/samsung/android/app/music/melon/list/chart/i;->i1(Lcom/samsung/android/app/music/melon/list/chart/i;Ljava/util/List;)V

    return-void
.end method

.method public static final i1(Lcom/samsung/android/app/music/melon/list/chart/i;Ljava/util/List;)V
    .registers 3
...
.method public Y0(Lkotlin/coroutines/d;)Ljava/lang/Object;
    ...
    .line 1
    iget-object p1, p0, Lcom/samsung/android/app/music/melon/list/chart/i;->R:Lcom/samsung/android/app/music/melon/room/c;
    ...
    :cond_0
    invoke-interface {p1}, Lcom/samsung/android/app/music/melon/room/c;->d()V

    .line 2
    iget-object p1, p0, Lcom/samsung/android/app/music/melon/list/chart/i;->S:Lcom/samsung/android/app/music/melon/api/i;
    ...
    invoke-static {p1, v2, v3, v1}, Lcom/samsung/android/app/music/melon/api/i$b;->c(Lcom/samsung/android/app/music/melon/api/i;IILjava/lang/Object;)Lretrofit2/b;
    ...
    check-cast v2, Lcom/samsung/android/app/music/melon/api/GenreChartsResponse;

    if-eqz v2, :cond_3

    .line 4
    iget-object v3, p0, Lcom/samsung/android/app/music/melon/list/chart/i;->R:Lcom/samsung/android/app/music/melon/room/c;
    ...
    :goto_0
    invoke-virtual {v2}, Lcom/samsung/android/app/music/melon/api/GenreChartsResponse;->getCharts()Ljava/util/List;

    move-result-object v0

    invoke-interface {v1, v0}, Lcom/samsung/android/app/music/melon/room/c;->n(Ljava/util/List;)V
...
.method public bridge synthetic b1()Lcom/samsung/android/app/music/melon/list/base/g$a;
    ...
    invoke-virtual {p0}, Lcom/samsung/android/app/music/melon/list/chart/i;->h1()Lcom/samsung/android/app/music/melon/list/chart/i$a;
...
.method public final g1()Lcom/samsung/android/app/music/melon/room/e;
    ...
    iget-object p0, p0, Lcom/samsung/android/app/music/melon/list/chart/i;->T:Lkotlin/g;
...
.method public h1()Lcom/samsung/android/app/music/melon/list/chart/i$a;
    .registers 1

    new-instance p0, Lcom/samsung/android/app/music/melon/list/chart/i$a;

    invoke-direct {p0}, Lcom/samsung/android/app/music/melon/list/chart/i$a;-><init>()V
...
.method public onAttach(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/samsung/android/app/music/melon/list/chart/i;->R:Lcom/samsung/android/app/music/melon/room/c;
    ...
    iput-object p1, p0, Lcom/samsung/android/app/music/melon/list/chart/i;->S:Lcom/samsung/android/app/music/melon/api/i;
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    .line 3
    invoke-virtual {p0}, Lcom/samsung/android/app/music/melon/list/chart/i;->g1()Lcom/samsung/android/app/music/melon/room/e;

    move-result-object p1

    invoke-virtual {p1}, Lcom/samsung/android/app/music/melon/room/e;->m()Landroidx/lifecycle/LiveData;
    ...
    new-instance v0, Lcom/samsung/android/app/music/melon/list/chart/h;

    invoke-direct {v0, p0}, Lcom/samsung/android/app/music/melon/list/chart/h;-><init>(Lcom/samsung/android/app/music/melon/list/chart/i;)V
    ...
    new-instance p2, Lcom/samsung/android/app/music/melon/list/chart/i$b;

    invoke-direct {p2, p0}, Lcom/samsung/android/app/music/melon/list/chart/i$b;-><init>(Lcom/samsung/android/app/music/melon/list/chart/i;)V
