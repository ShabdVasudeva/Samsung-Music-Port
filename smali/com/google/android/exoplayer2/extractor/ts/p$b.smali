.class public final Lcom/google/android/exoplayer2/extractor/ts/p$b;
...
.field public final f:Lcom/google/android/exoplayer2/util/d0;
...
.field public m:Lcom/google/android/exoplayer2/extractor/ts/p$b$a;

.field public n:Lcom/google/android/exoplayer2/extractor/ts/p$b$a;
...
.method public constructor <init>(Lcom/google/android/exoplayer2/extractor/b0;ZZ)V
    ...
    invoke-direct {p2, p1, p3, p3}, Lcom/google/android/exoplayer2/util/d0;-><init>([BII)V

    iput-object p2, p0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->f:Lcom/google/android/exoplayer2/util/d0;
...
.method public a([BII)V
    ...
    .line 6
    iget-object v2, v0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->f:Lcom/google/android/exoplayer2/util/d0;

    iget-object v3, v0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->g:[B

    const/4 v4, 0x0

    invoke-virtual {v2, v3, v4, v1}, Lcom/google/android/exoplayer2/util/d0;->i([BII)V

    .line 7
    iget-object v1, v0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->f:Lcom/google/android/exoplayer2/util/d0;

    const/16 v2, 0x8

    invoke-virtual {v1, v2}, Lcom/google/android/exoplayer2/util/d0;->b(I)Z
    ...
    invoke-virtual {v1}, Lcom/google/android/exoplayer2/util/d0;->k()V

    .line 9
    iget-object v1, v0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->f:Lcom/google/android/exoplayer2/util/d0;

    invoke-virtual {v1, v7}, Lcom/google/android/exoplayer2/util/d0;->e(I)I
    ...
    invoke-virtual {v1}, Lcom/google/android/exoplayer2/util/d0;->c()Z
    ...
    .line 17
    iget-object v0, v0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->n:Lcom/google/android/exoplayer2/extractor/ts/p$b$a;

    invoke-virtual {v0, v11}, Lcom/google/android/exoplayer2/extractor/ts/p$b$a;->f(I)V
    ...
    .line 25
    iget-object v3, v0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->f:Lcom/google/android/exoplayer2/util/d0;

    invoke-virtual {v3, v7}, Lcom/google/android/exoplayer2/util/d0;->b(I)Z
    ...
    invoke-virtual {v3, v7}, Lcom/google/android/exoplayer2/util/d0;->l(I)V
    ...
    invoke-virtual {v3, v5}, Lcom/google/android/exoplayer2/util/d0;->b(I)Z
    ...
    invoke-virtual {v3, v5}, Lcom/google/android/exoplayer2/util/d0;->e(I)I
    ...
    invoke-virtual {v3}, Lcom/google/android/exoplayer2/util/d0;->d()Z
    ...
    .line 32
    iget-object v6, v0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->f:Lcom/google/android/exoplayer2/util/d0;

    invoke-virtual {v6, v5}, Lcom/google/android/exoplayer2/util/d0;->b(I)Z
    ...
    invoke-virtual {v6}, Lcom/google/android/exoplayer2/util/d0;->d()Z
    ...
    invoke-virtual {v2}, Lcom/google/android/exoplayer2/util/d0;->c()Z
    ...
    invoke-virtual {v2, v3}, Lcom/google/android/exoplayer2/util/d0;->b(I)Z
    ...
    invoke-virtual {v2, v3}, Lcom/google/android/exoplayer2/util/d0;->e(I)I
...
.method public b(JIZZ)Z
    ...
    iget-object v3, p0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->m:Lcom/google/android/exoplayer2/extractor/ts/p$b$a;

    .line 2
    invoke-static {v0, v3}, Lcom/google/android/exoplayer2/extractor/ts/p$b$a;->a(Lcom/google/android/exoplayer2/extractor/ts/p$b$a;Lcom/google/android/exoplayer2/extractor/ts/p$b$a;)Z
    ...
    .line 4
    iget-wide v3, p0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->j:J
    ...
    .line 5
    invoke-virtual {p0, p3}, Lcom/google/android/exoplayer2/extractor/ts/p$b;->d(I)V
    ...
    .line 8
    iput-boolean v1, p0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->r:Z

    .line 9
    iput-boolean v2, p0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->o:Z
...
.method public c()Z
    ...
    iget-boolean p0, p0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->c:Z
...
.method public e(Lcom/google/android/exoplayer2/util/y$b;)V
    ...
    iget-object p0, p0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->e:Landroid/util/SparseArray;

    iget v0, p1, Lcom/google/android/exoplayer2/util/y$b;->a:I
...
.method public f(Lcom/google/android/exoplayer2/util/y$c;)V
    ...
    iget-object p0, p0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->d:Landroid/util/SparseArray;

    iget v0, p1, Lcom/google/android/exoplayer2/util/y$c;->d:I
...
.method public g()V
    ...
    .line 3
    iget-object p0, p0, Lcom/google/android/exoplayer2/extractor/ts/p$b;->n:Lcom/google/android/exoplayer2/extractor/ts/p$b$a;

    invoke-virtual {p0}, Lcom/google/android/exoplayer2/extractor/ts/p$b$a;->b()V
