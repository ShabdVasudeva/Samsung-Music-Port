...
# static fields
.field public static final b:Lkotlin/jvm/internal/f$a;
...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lkotlin/jvm/internal/f$a;-><init>(Lkotlin/jvm/internal/h;)V

    sput-object v0, Lkotlin/jvm/internal/f;->b:Lkotlin/jvm/internal/f$a;
    ...
    const-class v5, Lkotlin/jvm/functions/r;

    aput-object v5, v0, v2

    const/4 v2, 0x5

    const-class v5, Lkotlin/jvm/functions/s;

    aput-object v5, v0, v2

    const/4 v2, 0x6

    const-class v5, Lkotlin/jvm/functions/t;

    aput-object v5, v0, v2

    const/4 v2, 0x7

    const-class v5, Lkotlin/jvm/functions/u;

    aput-object v5, v0, v2

    const/16 v2, 0x8

    const-class v5, Lkotlin/jvm/functions/v;

    aput-object v5, v0, v2

    const/16 v2, 0x9

    const-class v5, Lkotlin/jvm/functions/w;
    ...
    const-class v6, Lkotlin/jvm/functions/c;

    aput-object v6, v0, v2

    const/16 v2, 0xc

    const-class v6, Lkotlin/jvm/functions/d;

    aput-object v6, v0, v2

    const/16 v2, 0xd

    const-class v6, Lkotlin/jvm/functions/e;

    aput-object v6, v0, v2

    const/16 v2, 0xe

    const-class v6, Lkotlin/jvm/functions/f;

    aput-object v6, v0, v2

    const/16 v2, 0xf

    const-class v6, Lkotlin/jvm/functions/g;

    aput-object v6, v0, v2

    const/16 v2, 0x10

    const-class v6, Lkotlin/jvm/functions/h;

    aput-object v6, v0, v2

    const/16 v2, 0x11

    const-class v6, Lkotlin/jvm/functions/i;

    aput-object v6, v0, v2

    const/16 v2, 0x12

    const-class v6, Lkotlin/jvm/functions/j;

    aput-object v6, v0, v2

    const/16 v2, 0x13

    const-class v6, Lkotlin/jvm/functions/k;

    aput-object v6, v0, v2

    const/16 v2, 0x14

    const-class v6, Lkotlin/jvm/functions/m;

    aput-object v6, v0, v2

    const/16 v2, 0x15

    const-class v6, Lkotlin/jvm/functions/n;
    ...
    .line 8
    :cond_1
    invoke-static {v2}, Lkotlin/collections/i0;->n(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    .line 18
    sput-object v0, Lkotlin/jvm/internal/f;->d:Ljava/util/HashMap;
    ...
    .line 28
    sput-object v2, Lkotlin/jvm/internal/f;->e:Ljava/util/HashMap;
    ...
    invoke-static {v2, v5, v1, v4, v1}, Lkotlin/text/p;->F0(Ljava/lang/String;CLjava/lang/String;ILjava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {v5, v2}, Lkotlin/r;->a(Ljava/lang/Object;Ljava/lang/Object;)Lkotlin/l;
    ...
    .line 56
    :cond_2
    sget-object v0, Lkotlin/jvm/internal/f;->c:Ljava/util/Map;
    ...
    .line 58
    :cond_3
    sput-object v3, Lkotlin/jvm/internal/f;->f:Ljava/util/HashMap;
    ...
    invoke-static {v2}, Lkotlin/collections/h0;->d(I)I
    ...
    invoke-static {v3, v5, v1, v4, v1}, Lkotlin/text/p;->F0(Ljava/lang/String;CLjava/lang/String;ILjava/lang/Object;)Ljava/lang/String;
...
.method public static final synthetic c()Ljava/util/Map;
    ...
    sget-object v0, Lkotlin/jvm/internal/f;->g:Ljava/util/Map;
...
.method public b()Ljava/lang/String;
    ...
    sget-object v0, Lkotlin/jvm/internal/f;->b:Lkotlin/jvm/internal/f$a;

    invoke-virtual {p0}, Lkotlin/jvm/internal/f;->a()Ljava/lang/Class;

    move-result-object p0

    invoke-virtual {v0, p0}, Lkotlin/jvm/internal/f$a;->a(Ljava/lang/Class;)Ljava/lang/String;
