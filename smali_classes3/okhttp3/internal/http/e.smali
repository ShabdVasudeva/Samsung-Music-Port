...
# static fields
.field public static final a:Lokio/i;

.field public static final b:Lokio/i;
...
.method public static constructor <clinit>()V
    ...
    sput-object v1, Lokhttp3/internal/http/e;->a:Lokio/i;
    ...
    sput-object v0, Lokhttp3/internal/http/e;->b:Lokio/i;
...
.method public static final a(Lokhttp3/u;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {v3, v4}, Lokio/f;->U0(Ljava/lang/String;)Lokio/f;

    move-result-object v3

    .line 5
    :try_start_0
    invoke-static {v3, v0}, Lokhttp3/internal/http/e;->c(Lokio/f;Ljava/util/List;)V
    :try_end_0
...
.method public static final b(Lokhttp3/e0;)Z
    .registers 9
    ...
    .line 3
    :cond_2
    invoke-static {p0}, Lokhttp3/internal/c;->s(Lokhttp3/e0;)J
    ...
    .line 4
    invoke-static {p0, v2, v4, v0, v4}, Lokhttp3/e0;->k(Lokhttp3/e0;Ljava/lang/String;Ljava/lang/String;ILjava/lang/Object;)Ljava/lang/String;

    move-result-object p0

    const-string v0, "chunked"

    invoke-static {v0, p0, v3}, Lkotlin/text/o;->r(Ljava/lang/String;Ljava/lang/String;Z)Z
...
.method public static final c(Lokio/f;Ljava/util/List;)V
    .registers 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-static {p0}, Lokhttp3/internal/http/e;->g(Lokio/f;)Z

    .line 2
    invoke-static {p0}, Lokhttp3/internal/http/e;->e(Lokio/f;)Ljava/lang/String;
    ...
    .line 7
    invoke-static {p0, v4}, Lokhttp3/internal/c;->H(Lokio/f;B)I
    ...
    invoke-static {v3, v5}, Lkotlin/text/o;->x(Ljava/lang/CharSequence;I)Ljava/lang/String;
    ...
    .line 20
    invoke-static {p0, v6}, Lokhttp3/internal/http/e;->h(Lokio/f;B)Z

    move-result v6

    if-eqz v6, :cond_a

    invoke-static {p0}, Lokhttp3/internal/http/e;->d(Lokio/f;)Ljava/lang/String;
...
.method public static final d(Lokio/f;)Ljava/lang/String;
    .registers 13
    ...
    .line 3
    :goto_1
    sget-object v2, Lokhttp3/internal/http/e;->a:Lokio/i;

    invoke-virtual {p0, v2}, Lokio/f;->r(Lokio/i;)J
    ...
    .line 5
    invoke-virtual {v0, p0, v2, v3}, Lokio/f;->N(Lokio/f;J)V
    ...
    .line 11
    invoke-virtual {v0, p0, v8, v9}, Lokio/f;->N(Lokio/f;J)V
...
.method public static final e(Lokio/f;)Ljava/lang/String;
    .registers 5

    .line 1
    sget-object v0, Lokhttp3/internal/http/e;->b:Lokio/i;

    invoke-virtual {p0, v0}, Lokio/f;->r(Lokio/i;)J
...
.method public static final f(Lokhttp3/n;Lokhttp3/v;Lokhttp3/u;)V
    ...
    .line 2
    :cond_0
    sget-object v0, Lokhttp3/m;->n:Lokhttp3/m$b;

    invoke-virtual {v0, p1, p2}, Lokhttp3/m$b;->e(Lokhttp3/v;Lokhttp3/u;)Ljava/util/List;
...
.method public static final g(Lokio/f;)Z
    .registers 4
...
.method public static final h(Lokio/f;B)Z
    .registers 4
