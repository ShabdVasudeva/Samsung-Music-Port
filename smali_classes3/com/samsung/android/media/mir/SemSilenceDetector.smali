...
.method private decodeFrontBack(Ljava/lang/String;ZJD)Lcom/samsung/android/media/mir/SemSilenceDetector$DecodeResult;
    ...
    .line 1
    new-instance v3, Lcom/samsung/android/media/mir/SemSilenceDetector$DecodeResult;

    const/4 v4, 0x0

    invoke-direct {v3, v0, v4}, Lcom/samsung/android/media/mir/SemSilenceDetector$DecodeResult;-><init>(Lcom/samsung/android/media/mir/SemSilenceDetector;Lcom/samsung/android/media/mir/SemSilenceDetector$DecodeResult;)V
    ...
    iput-object v11, v3, Lcom/samsung/android/media/mir/SemSilenceDetector$DecodeResult;->mime:Ljava/lang/String;
    ...
    iput v11, v3, Lcom/samsung/android/media/mir/SemSilenceDetector$DecodeResult;->Hz:I
    ...
    iput v11, v3, Lcom/samsung/android/media/mir/SemSilenceDetector$DecodeResult;->nCh:I
    ...
    iput-wide v13, v3, Lcom/samsung/android/media/mir/SemSilenceDetector$DecodeResult;->duration:J
    :try_end_1
    ...
    .line 14
    iget-wide v8, v0, Lcom/samsung/android/media/mir/SemSilenceDetector;->mMinDurationUs:J
    ...
    .line 15
    :cond_3
    iget-object v8, v3, Lcom/samsung/android/media/mir/SemSilenceDetector$DecodeResult;->mime:Ljava/lang/String;
    ...
    iput-wide v7, v3, Lcom/samsung/android/media/mir/SemSilenceDetector$DecodeResult;->findFrontUs:J

    .line 24
    aget-wide v1, v1, v12

    iput-wide v1, v3, Lcom/samsung/android/media/mir/SemSilenceDetector$DecodeResult;->findBackUs:J
    ...
    .line 27
    iput-wide v1, v3, Lcom/samsung/android/media/mir/SemSilenceDetector$DecodeResult;->findFrontUs:J
    ...
    .line 29
    iget-object v1, v3, Lcom/samsung/android/media/mir/SemSilenceDetector$DecodeResult;->mime:Ljava/lang/String;
    ...
    .line 31
    invoke-virtual {v1, v10, v4, v4, v2}, Landroid/media/MediaCodec;->configure(Landroid/media/MediaFormat;Landroid/view/Surface;Landroid/media/MediaCrypto;I)V
    ...
    .line 42
    iget v9, v3, Lcom/samsung/android/media/mir/SemSilenceDetector$DecodeResult;->Hz:I

    div-int/lit8 v9, v9, 0x64

    iget v13, v3, Lcom/samsung/android/media/mir/SemSilenceDetector$DecodeResult;->nCh:I
    ...
    .line 44
    iget-wide v13, v0, Lcom/samsung/android/media/mir/SemSilenceDetector;->kTimeOutUs:J
    ...
    .line 54
    invoke-virtual {v1, v10, v4, v4, v7}, Landroid/media/MediaCodec;->configure(Landroid/media/MediaFormat;Landroid/view/Surface;Landroid/media/MediaCrypto;I)V
    ...
    .line 60
    iget v4, v3, Lcom/samsung/android/media/mir/SemSilenceDetector$DecodeResult;->nCh:I
    ...
    .line 68
    invoke-virtual {v1, v13, v4}, Landroid/media/MediaCodec;->releaseOutputBuffer(IZ)V
    ...
    .line 69
    iget v4, v3, Lcom/samsung/android/media/mir/SemSilenceDetector$DecodeResult;->Hz:I
    ...
    .line 76
    iget v12, v3, Lcom/samsung/android/media/mir/SemSilenceDetector$DecodeResult;->Hz:I
    ...
    .line 77
    iput-wide v4, v3, Lcom/samsung/android/media/mir/SemSilenceDetector$DecodeResult;->findBackUs:J

    .line 78
    :cond_1d
    iget-wide v4, v3, Lcom/samsung/android/media/mir/SemSilenceDetector$DecodeResult;->findFrontUs:J

    iget v2, v3, Lcom/samsung/android/media/mir/SemSilenceDetector$DecodeResult;->Hz:I

    iget v7, v3, Lcom/samsung/android/media/mir/SemSilenceDetector$DecodeResult;->nCh:I

    invoke-direct {v0, v4, v5, v2, v7}, Lcom/samsung/android/media/mir/SemSilenceDetector;->byteOffsetToTimeUs(JII)J

    move-result-wide v4

    iput-wide v4, v3, Lcom/samsung/android/media/mir/SemSilenceDetector$DecodeResult;->findFrontUs:J

    .line 79
    iget-wide v4, v3, Lcom/samsung/android/media/mir/SemSilenceDetector$DecodeResult;->findBackUs:J
    ...
    .line 81
    iget-wide v4, v3, Lcom/samsung/android/media/mir/SemSilenceDetector$DecodeResult;->duration:J
    ...
    .line 83
    iget-wide v7, v0, Lcom/samsung/android/media/mir/SemSilenceDetector;->kTimeOutUs:J
    ...
    invoke-virtual {v1, v2, v7, v8}, Landroid/media/MediaCodec;->dequeueOutputBuffer(Landroid/media/MediaCodec$BufferInfo;J)I
    ...
    invoke-static {v0, v4}, Ljava/util/Arrays;->copyOf([SI)[S
    ...
    invoke-virtual {v8, v0, v15, v4}, Ljava/nio/ShortBuffer;->get([SII)Ljava/nio/ShortBuffer;
    ...
    .line 103
    invoke-virtual {v1, v7, v4}, Landroid/media/MediaCodec;->releaseOutputBuffer(IZ)V
    ...
    .line 109
    iput-wide v11, v3, Lcom/samsung/android/media/mir/SemSilenceDetector$DecodeResult;->findBackUs:J
...
.method public getSilencePosition(D)[J
    ...
    .line 4
    iget-wide v3, p0, Lcom/samsung/android/media/mir/SemSilenceDetector$DecodeResult;->findFrontUs:J

    aput-wide v3, v0, p2

    .line 5
    iget-wide v3, p0, Lcom/samsung/android/media/mir/SemSilenceDetector$DecodeResult;->duration:J

    iget-wide v5, p0, Lcom/samsung/android/media/mir/SemSilenceDetector$DecodeResult;->findBackUs:J
