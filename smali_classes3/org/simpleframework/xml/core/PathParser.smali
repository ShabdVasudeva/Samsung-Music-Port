...
.method private attribute()V
    ...
    const-string p0, "Illegal character \'%s\' in attribute for \'%s\' in %s"

    invoke-direct {v0, p0, v3}, Lorg/simpleframework/xml/core/PathException;-><init>(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string p0, "Attribute reference in \'%s\' for %s is empty"

    invoke-direct {v0, p0, v2}, Lorg/simpleframework/xml/core/PathException;-><init>(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private element()V
    ...
    const-string p0, "Illegal character \'%s\' in element for \'%s\' in %s"
...
.method private index()V
    ...
    const-string p0, "Invalid index for path \'%s\' in %s"
...
.method private path()V
    ...
    const-string p0, "Path \'%s\' in %s references an invalid attribute"
    ...
    const-string p0, "Path \'%s\' in %s references document root"
...
.method private segment()V
    ...
    const-string p0, "Invalid path expression \'%s\' in %s"
...
.method private skip()V
    ...
    const-string p0, "Path \'%s\' in %s has an illegal syntax"
