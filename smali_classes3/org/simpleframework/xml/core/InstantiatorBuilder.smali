...
.method private register(Lorg/simpleframework/xml/core/Label;Lorg/simpleframework/xml/core/LabelMap;)V
    ...
    .line 8
    invoke-virtual {p2, p0}, Ljava/util/LinkedHashMap;->containsKey(Ljava/lang/Object;)Z
    ...
    .line 12
    invoke-virtual {p2, p0}, Ljava/util/LinkedHashMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;
...
.method private validate(Lorg/simpleframework/xml/core/Detail;)V
    ...
    invoke-direct {p0, p1, v0}, Lorg/simpleframework/xml/core/ConstructorException;-><init>(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private validateAnnotations(Lorg/simpleframework/xml/core/Label;Lorg/simpleframework/xml/core/Parameter;)V
    ...
    const-string p0, "Annotation %s does not match %s for \'%s\' in %s"

    invoke-direct {v0, p0, v2}, Lorg/simpleframework/xml/core/ConstructorException;-><init>(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private validateConstructors(Lorg/simpleframework/xml/core/LabelMap;)V
    ...
    const-string p0, "Default constructor can not accept read only %s in %s"

    invoke-direct {p1, p0, v1}, Lorg/simpleframework/xml/core/ConstructorException;-><init>(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private validateConstructors(Lorg/simpleframework/xml/core/LabelMap;Ljava/util/List;)V
    ...
    const-string p0, "No constructor accepts all read only values in %s"
