...
# instance fields
.field public final C:Lio/reactivex/internal/fuseable/a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
# direct methods
.method public constructor <init>(Lio/reactivex/internal/fuseable/a;Lio/reactivex/r$b;ZI)V
    .registers 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/i$b;->C:Lio/reactivex/internal/fuseable/a;
...
.method public i(Lorg/reactivestreams/c;)V
    ...
    .line 9
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/i$b;->C:Lio/reactivex/internal/fuseable/a;
    ...
    .line 12
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/i$b;->C:Lio/reactivex/internal/fuseable/a;

    invoke-interface {v0, p0}, Lio/reactivex/l;->i(Lorg/reactivestreams/c;)V
...
.method public j()V
    ...
    .line 4
    iget-wide v4, p0, Lio/reactivex/internal/operators/flowable/i$b;->D:J
    ...
    :cond_0
    :goto_0
    iget-object v8, p0, Lio/reactivex/internal/operators/flowable/i$a;->e:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    .line 6
    iget-boolean v11, p0, Lio/reactivex/internal/operators/flowable/i$a;->i:Z
    ...
    .line 8
    :goto_2
    invoke-virtual {p0, v11, v13, v0}, Lio/reactivex/internal/operators/flowable/i$a;->g(ZZLorg/reactivestreams/b;)Z
    ...
    .line 9
    :cond_4
    invoke-interface {v0, v12}, Lio/reactivex/internal/fuseable/a;->m(Ljava/lang/Object;)Z
    ...
    .line 10
    iget v10, p0, Lio/reactivex/internal/operators/flowable/i$a;->d:I
    ...
    .line 11
    iget-object v10, p0, Lio/reactivex/internal/operators/flowable/i$a;->f:Lorg/reactivestreams/c;

    invoke-interface {v10, v4, v5}, Lorg/reactivestreams/c;->h(J)V
    ...
    .line 13
    iput-boolean v6, p0, Lio/reactivex/internal/operators/flowable/i$a;->h:Z
    ...
    .line 18
    iget-boolean v8, p0, Lio/reactivex/internal/operators/flowable/i$a;->i:Z

    invoke-interface {v1}, Lio/reactivex/internal/fuseable/e;->isEmpty()Z

    move-result v9

    invoke-virtual {p0, v8, v9, v0}, Lio/reactivex/internal/operators/flowable/i$a;->g(ZZLorg/reactivestreams/b;)Z
    ...
    .line 21
    iput-wide v4, p0, Lio/reactivex/internal/operators/flowable/i$b;->D:J
...
.method public o()V
    ...
    .line 3
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/i$b;->C:Lio/reactivex/internal/fuseable/a;
    ...
    .line 6
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/i$b;->C:Lio/reactivex/internal/fuseable/a;
...
.method public p()V
    ...
    .line 10
    :cond_3
    invoke-interface {v0, v8}, Lio/reactivex/internal/fuseable/a;->m(Ljava/lang/Object;)Z
...
.method public poll()Ljava/lang/Object;
    ...
    .line 3
    iget-wide v1, p0, Lio/reactivex/internal/operators/flowable/i$b;->D:J
    ...
    .line 5
    iput-wide v3, p0, Lio/reactivex/internal/operators/flowable/i$b;->D:J
    ...
    .line 7
    :cond_0
    iput-wide v1, p0, Lio/reactivex/internal/operators/flowable/i$b;->D:J
