...
.field public nextRight:Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesToIntTask;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field public rights:Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesToIntTask;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesToIntTask<",
            "TK;TV;>;"
...
.method public constructor <init>(Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$BulkTask;III[Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$Node;Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesToIntTask;Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$ObjectToInt;ILio/netty/util/internal/chmv8/ConcurrentHashMapV8$IntByIntToInt;)V
    ...
    .line 2
    iput-object p7, p0, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesToIntTask;->transformer:Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$ObjectToInt;

    .line 3
    iput p8, p0, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesToIntTask;->basis:I

    iput-object p9, p0, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesToIntTask;->reducer:Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$IntByIntToInt;
...
.method public final compute()V
    ...
    .line 1
    iget-object v10, p0, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesToIntTask;->transformer:Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$ObjectToInt;

    if-eqz v10, :cond_3

    iget-object v11, p0, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesToIntTask;->reducer:Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$IntByIntToInt;

    if-eqz v11, :cond_3

    .line 2
    iget v12, p0, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesToIntTask;->basis:I
    ...
    .line 5
    new-instance v14, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesToIntTask;
    ...
    iput-object v14, p0, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesToIntTask;->rights:Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesToIntTask;
    ...
    .line 8
    :cond_1
    iput v12, p0, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesToIntTask;->result:I
    ...
    .line 11
    iget-object v1, v0, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesToIntTask;->rights:Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesToIntTask;

    :goto_3
    if-eqz v1, :cond_2

    .line 12
    iget v2, v0, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesToIntTask;->result:I

    iget v3, v1, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesToIntTask;->result:I

    invoke-interface {v11, v2, v3}, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$IntByIntToInt;->apply(II)I

    move-result v2

    iput v2, v0, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesToIntTask;->result:I

    .line 13
    iget-object v1, v1, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesToIntTask;->nextRight:Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesToIntTask;

    iput-object v1, v0, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesToIntTask;->rights:Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesToIntTask;
...
.method public final getRawResult()Ljava/lang/Integer;
    ...
    .line 2
    iget p0, p0, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesToIntTask;->result:I
