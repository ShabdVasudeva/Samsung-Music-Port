...
# instance fields
.field public nextRight:Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesTask;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field public rights:Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesTask;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesTask<",
            "TK;TV;TU;>;"
...
.method public constructor <init>(Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$BulkTask;III[Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$Node;Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesTask;Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$Fun;Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$BiFun;)V
    ...
    .line 2
    iput-object p7, p0, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesTask;->transformer:Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$Fun;

    .line 3
    iput-object p8, p0, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesTask;->reducer:Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$BiFun;
...
.method public final compute()V
    ...
    .line 1
    iget-object v9, p0, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesTask;->transformer:Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$Fun;

    if-eqz v9, :cond_7

    iget-object v10, p0, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesTask;->reducer:Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$BiFun;
    ...
    .line 4
    new-instance v12, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesTask;
    ...
    iput-object v12, p0, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesTask;->rights:Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesTask;
    ...
    .line 11
    iget-object v1, v0, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesTask;->rights:Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesTask;

    :goto_4
    if-eqz v1, :cond_6

    .line 12
    iget-object v2, v1, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesTask;->result:Ljava/lang/Object;

    if-eqz v2, :cond_5

    .line 13
    iget-object v3, v0, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesTask;->result:Ljava/lang/Object;
    ...
    .line 14
    :cond_5
    iget-object v1, v1, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesTask;->nextRight:Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesTask;

    iput-object v1, v0, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesTask;->rights:Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesTask;
...
.method public final getRawResult()Ljava/lang/Object;
    ...
    iget-object p0, p0, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceValuesTask;->result:Ljava/lang/Object;
