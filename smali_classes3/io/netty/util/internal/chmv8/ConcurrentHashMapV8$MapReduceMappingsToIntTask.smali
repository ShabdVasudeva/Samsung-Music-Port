...
.field public nextRight:Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceMappingsToIntTask;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field public rights:Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceMappingsToIntTask;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceMappingsToIntTask<",
            "TK;TV;>;"
...
.field public final transformer:Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$ObjectByObjectToInt;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public final compute()V
    ...
    .line 11
    iget-object v1, v0, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceMappingsToIntTask;->rights:Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceMappingsToIntTask;

    :goto_3
    if-eqz v1, :cond_2

    .line 12
    iget v2, v0, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceMappingsToIntTask;->result:I
    ...
    iput v2, v0, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceMappingsToIntTask;->result:I

    .line 13
    iget-object v1, v1, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceMappingsToIntTask;->nextRight:Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceMappingsToIntTask;

    iput-object v1, v0, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceMappingsToIntTask;->rights:Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceMappingsToIntTask;
...
.method public final getRawResult()Ljava/lang/Integer;
    ...
    .line 2
    iget p0, p0, Lio/netty/util/internal/chmv8/ConcurrentHashMapV8$MapReduceMappingsToIntTask;->result:I
