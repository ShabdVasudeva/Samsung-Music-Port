.class synthetic Lio/netty/handler/ssl/OpenSslEngine$1;
...
.field public static final synthetic $SwitchMap$io$netty$handler$ssl$OpenSslEngine$HandshakeState:[I
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lio/netty/handler/ssl/OpenSslEngine$1;->$SwitchMap$io$netty$handler$ssl$ApplicationProtocolConfig$Protocol:[I
    ...
    :try_start_2
    sget-object v3, Lio/netty/handler/ssl/OpenSslEngine$1;->$SwitchMap$io$netty$handler$ssl$ApplicationProtocolConfig$Protocol:[I
    ...
    :try_start_3
    sget-object v4, Lio/netty/handler/ssl/OpenSslEngine$1;->$SwitchMap$io$netty$handler$ssl$ApplicationProtocolConfig$Protocol:[I
    ...
    sput-object v4, Lio/netty/handler/ssl/OpenSslEngine$1;->$SwitchMap$io$netty$handler$ssl$ClientAuth:[I
    ...
    :catch_4
    :try_start_5
    sget-object v4, Lio/netty/handler/ssl/OpenSslEngine$1;->$SwitchMap$io$netty$handler$ssl$ClientAuth:[I
    ...
    .line 3
    :catch_6
    invoke-static {}, Lio/netty/handler/ssl/OpenSslEngine$HandshakeState;->values()[Lio/netty/handler/ssl/OpenSslEngine$HandshakeState;
    ...
    sput-object v4, Lio/netty/handler/ssl/OpenSslEngine$1;->$SwitchMap$io$netty$handler$ssl$OpenSslEngine$HandshakeState:[I

    :try_start_7
    sget-object v5, Lio/netty/handler/ssl/OpenSslEngine$HandshakeState;->NOT_STARTED:Lio/netty/handler/ssl/OpenSslEngine$HandshakeState;
    ...
    :catch_7
    :try_start_8
    sget-object v1, Lio/netty/handler/ssl/OpenSslEngine$1;->$SwitchMap$io$netty$handler$ssl$OpenSslEngine$HandshakeState:[I

    sget-object v4, Lio/netty/handler/ssl/OpenSslEngine$HandshakeState;->FINISHED:Lio/netty/handler/ssl/OpenSslEngine$HandshakeState;
