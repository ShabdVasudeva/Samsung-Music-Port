...
.method public constructor <init>(Lio/netty/handler/timeout/IdleStateHandler;Lio/netty/channel/ChannelHandlerContext;)V
    ...
    .line 2
    iput-object p2, p0, Lio/netty/handler/timeout/IdleStateHandler$ReaderIdleTimeoutTask;->ctx:Lio/netty/channel/ChannelHandlerContext;
...
.method public run()V
    ...
    .line 1
    iget-object v0, p0, Lio/netty/handler/timeout/IdleStateHandler$ReaderIdleTimeoutTask;->ctx:Lio/netty/channel/ChannelHandlerContext;
    ...
    invoke-static {v0}, Lio/netty/handler/timeout/IdleStateHandler;->access$200(Lio/netty/handler/timeout/IdleStateHandler;)J
    ...
    iget-object v1, p0, Lio/netty/handler/timeout/IdleStateHandler$ReaderIdleTimeoutTask;->ctx:Lio/netty/channel/ChannelHandlerContext;
    ...
    invoke-static {v2}, Lio/netty/handler/timeout/IdleStateHandler;->access$200(Lio/netty/handler/timeout/IdleStateHandler;)J
    ...
    iput-object v1, v0, Lio/netty/handler/timeout/IdleStateHandler;->readerIdleTimeout:Ljava/util/concurrent/ScheduledFuture;
    ...
    invoke-static {v0}, Lio/netty/handler/timeout/IdleStateHandler;->access$400(Lio/netty/handler/timeout/IdleStateHandler;)Z
    ...
    invoke-static {v1}, Lio/netty/handler/timeout/IdleStateHandler;->access$400(Lio/netty/handler/timeout/IdleStateHandler;)Z
    ...
    invoke-static {v1, v2}, Lio/netty/handler/timeout/IdleStateHandler;->access$402(Lio/netty/handler/timeout/IdleStateHandler;Z)Z

    .line 9
    :cond_2
    iget-object v1, p0, Lio/netty/handler/timeout/IdleStateHandler$ReaderIdleTimeoutTask;->this$0:Lio/netty/handler/timeout/IdleStateHandler;

    iget-object v2, p0, Lio/netty/handler/timeout/IdleStateHandler$ReaderIdleTimeoutTask;->ctx:Lio/netty/channel/ChannelHandlerContext;
    ...
    .line 10
    iget-object p0, p0, Lio/netty/handler/timeout/IdleStateHandler$ReaderIdleTimeoutTask;->ctx:Lio/netty/channel/ChannelHandlerContext;
    ...
    iget-object v3, p0, Lio/netty/handler/timeout/IdleStateHandler$ReaderIdleTimeoutTask;->ctx:Lio/netty/channel/ChannelHandlerContext;
    ...
    iput-object p0, v2, Lio/netty/handler/timeout/IdleStateHandler;->readerIdleTimeout:Ljava/util/concurrent/ScheduledFuture;
